...
public final class FindMeetingQueryTest {
  ...
  public void optionalAttendeeIsNotConsidered() {
    // The optional attendee will not affect the outcome
    // Required attendees: A, B
    // Optional attendees: C
    // Events  :       |--A--|     |--B--|
    //           |--------------C--------------|
    // Day     : |-----------------------------|
    // Options : |--1--|     |--2--|     |--3--|
    ...
    Collection<Event> events = Arrays.asList(
        new Event("Event 3", TimeRange.
            fromStartEnd(TimeRange.START_OF_DAY, TimeRange.END_OF_DAY, true), 
  ...
  public void optionalAttendeeIsConsidered() {
    // The optional attendee will be considered and affect the outcome
    // Required attendees: A, B
    // Optional attendees: C
    // Events  :       |--A--|--C--|--B--|
    // Day     : |-----------------------------|
  ...
  public void justEnoughRoomWithOptionalAttendee() {
    // The optional attendee B will not affect the outcome
  ...
  public void allOptionalAttendeesWithGaps() {
    // No mandatory attendees, but two optional attendees with several gaps in their schedules
    // the options will be those gaps
    // Events  : |--A--|     |--B--|     |--A--|
    // Day     : |-----------------------------|
    // Options :       |--1--|     |--2--|
    Collection<Event> events = Arrays.asList(
  ...
  public void allOptionalAttendeesWithNoGaps() {
    // No mandatory attendees, but two optional attendees with no gaps in their schedules
